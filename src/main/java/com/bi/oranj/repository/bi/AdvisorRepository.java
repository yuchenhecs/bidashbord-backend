...
public interface AdvisorRepository extends JpaRepository<Advisor, Long> {
    ...
    @Query (value = "SELECT a.id advisorId, a.advisor_first_name firstName, a.advisor_last_name lastName, g.type type, " +
            ...
            "inner join goals g on " +
            "g.advisor_id = a.id " +
            "WHERE a.firm_id = :firmId AND g.creation_date BETWEEN :startDate' 00:00:00' and :endDate' 23:59:59' " +
            "ORDER BY a.advisor_first_name LIMIT :start, :next) t " +
            "on t.advisor_first_name = a.advisor_first_name " +
    ...
    @Query (value = "SELECT a.id advisorId, a.advisor_first_name firstName, a.advisor_last_name lastName, g.type type, " +
            ...
            "inner join goals g on " +
            "g.advisor_id = a.id " +
            "WHERE a.firm_id = :firmId AND g.creation_date <= :endDate' 23:59:59' " +
            "ORDER BY a.advisor_first_name LIMIT :start, :next) t " +
            "on t.advisor_first_name = a.advisor_first_name " +
    ...
    @Query (value = "SELECT a.id advisorId, a.advisor_first_name firstName, a.advisor_last_name lastName, g.type type, " +
            ...
            "inner join goals g on " +
            "g.advisor_id = a.id " +
            "WHERE a.firm_id = :firmId AND g.creation_date >= :startDate' 00:00:00' " +
            "ORDER BY a.advisor_first_name LIMIT :start, :next) t " +
            "on t.advisor_first_name = a.advisor_first_name " +
